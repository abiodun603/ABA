      ...
      <TouchableOpacity 
        ...
        className='mb-3'>
          ...
          <View className="flex-row items-center justify-between mt-3">
            <Text >{members?.length || "0"} {isEventDateLessThanCurrent(event_date) ? "attended this event in" : (<Text>going <Text className='text-2xl'>.</Text></Text>)}  <Text className='capitalize'>{event_city}</Text></Text>
