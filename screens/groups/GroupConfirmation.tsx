...
const GroupConfirmation: React.FC<Props> = ({ navigation: { navigate } }) => {
    ...
    <View style={styles.container}>
      <View className='px-5'>
        <View>
          ...
          <Text className='text-black leading-6 text-[18px] font-semibold mt-3'>Welcome to Lagos Purpose of Life in Buddhism Meetup</Text>
          <Text className='text-gray-800 text-sm font-normal mt-2'>Yay! You've joined a group and you're on your way to making new connections</Text>
        </View>
       
        <View className='mt-3'>
          <Text className='text-black leading-6 text-[18px] font-semibold mt-3 mb-3'>Upcoming Events</Text>
          <View>
            <FlatList
              horizontal
              data = {[1, 2, 3, 4]}
